...
local function update_general_flow(general_flow)
    local channel=general_flow.parent["selection_flow"]["channel_selector"].items[general_flow.parent["selection_flow"]["channel_selector"].selected_index]
    general_flow.clear()
    local flows={}
                        ...
                        children={
                            {
                                ...
                                caption="[planet="..planet.name.."] Requester n°:"..number,
...
local function create_lpn_manager_gui(player)
    ...
    --player.opened = lpn_manager["LPN-manager-gui"]
end
